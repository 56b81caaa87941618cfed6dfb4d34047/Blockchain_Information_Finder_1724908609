...
<template>
    <div class="flex">
        <!-- Sidebar -->
        <div class="w-64 bg-purple-900 bg-opacity-50 backdrop-filter backdrop-blur-lg h-screen">
            <nav class="mt-10">
                <a href="#" class="flex items-center px-6 py-2 text-pink-200 hover:bg-purple-700 hover:bg-opacity-50 rounded-lg transition duration-300">
                    <i class='bx bxs-home mr-3'></i>
                    Home
                </a>
                <a href="#" class="flex items-center px-6 py-2 mt-4 text-pink-200 hover:bg-purple-700 hover:bg-opacity-50 rounded-lg transition duration-300">
        ...
        <!-- Main Content -->
        <div class="flex-1">
            <footer id="footer-section" style="min-height: 350px" class="flex-1 bg-gradient-to-r from-purple-600 to-pink-500 bg-opacity-70 backdrop-filter backdrop-blur-lg">
