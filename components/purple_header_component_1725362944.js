        ...
        <div class="md:hidden flex items-center ml-4">
          ...
          >
            <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
              ...
              <li>
                <a id="mobile-Projects-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Projects.html">Projects</a>
              </li>
              <li>
                <a id="mobile-Learn-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Learn.html">Learn</a>
              </li>
              <li>
                <a id="mobile-Connect-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Connect.html">Connect</a>
              </li>
            </ul>
          </nav>
        </div>
